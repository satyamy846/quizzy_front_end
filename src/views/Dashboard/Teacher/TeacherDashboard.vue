    ...
    <section class="section courses" id="courses">
        <div class="container">
            ...
            <ul class="event_filter">
                <li>
                  <router-link to="/teacher/dashboard" active-class="active">Dashboard</router-link> 
                </li>
                <li>
                   <router-link to="/teacher/profile">Profile</router-link> 
                </li>
                <li>
                  <router-link to="/teacher/view-quiz">View Quiz</router-link>
                </li>
                <li>
                  <router-link to="/teacher/add-quiz">Add Quiz</router-link>
                </li>
                <li>
                  <router-link to="/teacher/add-questions">Add Questions</router-link>
                </li>
                
            </ul>
            
            <div class="image-container">
              <img src="../../../assests/images/50426.jpg" alt="laptop" class="image1">
            </div>
        </div>
    </section>
